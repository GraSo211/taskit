...
export function EventEditor({ event, onClose, onSave }: EventEditorProps) {
  ...
  const titleRef = useRef<HTMLInputElement>(null); const { dialogRef, onKeyDown } = useDialogKeyboard<HTMLDivElement>(onClose, titleRef);
