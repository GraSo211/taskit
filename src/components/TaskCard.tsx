...
type TaskCardProps = { task: Task; onToggle?: (id: string) => void; onEdit?: () => void; onSubtaskToggle?: (subtaskId: string, completed: boolean) => Promise<void>; onSubtaskAdd?: (parentId: string | null, title: string) => Promise<void>; onSubtaskRename?: (subtaskId: string, title: string) => Promise<void>; onSubtaskDelete?: (subtaskId: string) => Promise<void>; onSubtaskMove?: (subtaskId: string, parentId: string | null, position: number) => Promise<void> };

export function TaskCard({ task, onToggle, onEdit, onSubtaskToggle, onSubtaskAdd, onSubtaskRename, onSubtaskDelete, onSubtaskMove }: TaskCardProps) {
