...
type DashboardTask = { id: string; title: string; description: string | null; frequency: "DAILY" | "WEEKLY"; targetCount: number; scheduledWeekdays: number[]; reminderTime: string | null; timezone: string; startDate: string; todayKey: string; completedToday: boolean; progress: { daily: Progress; weekly: Progress }; history?: TaskHistory };
