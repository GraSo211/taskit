...
export default function EventsClient({ data }: { data: EventData }) {
  ...
  return <DashboardShell userName={data.user.name} navItems={navItems} onCreate={() => setEditor("new")} onSignOut={logout} heading="Eventos que toman forma" description="Sigue un recorrido día a día, con claridad sobre lo que viene después.">
